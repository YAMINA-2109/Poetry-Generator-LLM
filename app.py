...
# 
# # Header Section
# st.title("🌟 Poetry Generator & Evaluator")
...
# tab1, tab2 = st.tabs(["📝 Generate & Evaluate a Single Poem", "📂 Evaluate Poems on a Dataset"])
# 
...
# 
#                         # Calcul des métriques BLEU et ROUGE
